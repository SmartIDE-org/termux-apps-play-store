...
public final class TerminalEmulator {
    ...
    private void doDeviceControl(int b) {
        if (checkIfApcOrOscOrDcsEndsWithStringTerminator(b)) {
    ...
    private boolean checkIfApcOrOscOrDcsEndsWithStringTerminator(int b) {
    ...
    private void collectOSCArgs(int b) {
        ...
        } else if (mApcOrOscOrDcsArgs.length() < MAX_OSC_STRING_LENGTH) {
            mApcOrOscOrDcsArgs.appendCodePoint(b);
            continueSequence(mEscapeState);
        } else {
            unknownSequence(b);
